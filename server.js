...
const careProviderRoutes = require('./backend/routes/careProvider');
console.log('✅ Care provider routes imported successfully');
...
app.use('/api/care-provider', careProviderRoutes);
console.log('✅ Care provider routes mounted at /api/care-provider');
